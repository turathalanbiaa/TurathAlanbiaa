        ...
        <div class="column">
            <div class="ui inverted top attached segment">
                ...
                <h1 class="ui center aligned header">
                    <span>الاسئلة الشائعة - اضافة سؤال جديد</span>
                </h1>
                <div class="ui hidden divider"></div>
            </div>
            ...
            <div class="ui attached segment">
                ...
                @if(session("CreateFAQMessage"))
                    <div class="ui success message">
                        <div class="ui center aligned green header">{{session("CreateFAQMessage")}}</div>
                    </div>
                    <div class="ui divider"></div>
                    <div class="ui hidden divider"></div>
                @endif

                <form class="ui large form" method="post" action="/ControlPanel/faq/create/validate">
                    {!! csrf_field() !!}
