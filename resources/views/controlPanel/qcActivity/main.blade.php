    ...
    <div class="ui segment">
        <div class="ui grid">
            <div class="thirteen wide computer thirteen wide tablet sixteen wide mobile column">
                <form class="ui large form" method="get" action="/ControlPanel/qcActivities" dir="rtl">
            ...
            <div class="three wide computer three wide tablet sixteen wide mobile column">
                <a class="ui fluid positive large button" href="/ControlPanel/qcActivity/create">
                    <span>أضافة</span>
                </a>
            </div>
...
@section("script")
    <script>
        ...
        $("button.positive.button").click(function () {
            ...
            $.ajax({
                type: "POST",
                url: "/ControlPanel/qcActivity/delete",
